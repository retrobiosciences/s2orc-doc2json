...
class GrobidClient(ApiClient):
    ...
    def process_pdf_stream(self, pdf_file: str, pdf_strm: bytes, output: str, service: str) -> str:
        ...
        if status == 503:
            ...
            return self.process_pdf_stream(pdf_file=pdf_file, pdf_strm=pdf_strm, output=output, service=service)
        if status != 200:
    ...
    def process_pdf(self, pdf_file: str, output: str, service: str) -> None:
        ...
        tei_text = self.process_pdf_stream(pdf_file, pdf_strm, output=output, service=service)
